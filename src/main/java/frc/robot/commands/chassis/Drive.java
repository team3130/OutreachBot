...
public class Drive extends CommandBase {
  ...
  public void execute() {   //called continuously/repeatedly when the command is scheduled
      m_chassis.driveArcade(m_chassis.moveSpeed(m_robotContainer.returnController()), m_chassis.turnSpeed(m_robotContainer.returnController()), true); //method to drive
    }
